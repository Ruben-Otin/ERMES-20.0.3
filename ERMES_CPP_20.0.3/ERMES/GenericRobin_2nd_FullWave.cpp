...
#include "GenericRobin_2nd_FullWave.h"
...
{  	
    ...
    //**********************************************************************************************************************	
    void GenericRobin_2nd_FullWave::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    // - Area of the element
    //**********************************************************************************************************************
    double GenericRobin_2nd_FullWave::Calculate_Area()
    {
    ...
    //* - Exterior normal 
    //**********************************************************************************************************************	
    void GenericRobin_2nd_FullWave::Calculate_Exterior_Normal( Vector<double>& Next )
    {
		double v1[ 3 ], v2[ 3 ];
    ...
    //**********************************************************************************************************************	
    std::complex<double> GenericRobin_2nd_FullWave::Calculate_jK_div_Mu()
    {
        // Gaussian beam 
    ...
    //* - jk = j * w * sqrt ( ep * mu )
    //**********************************************************************************************************************	
    std::complex<double> GenericRobin_2nd_FullWave::Calculate_jK()
    {
        // Gaussian beam 
        if( (*mProperties)( COMPLEX_NEUMANN_FLOW )[ 5 ] == 3.0 )
        {
    ...
    //**********************************************************************************************************************	
    void GenericRobin_2nd_FullWave::Calculate_NiNj_Matrix( Matrix<double>& NiNj_Matrix )
    {
        // Setting NiNj matrix
    ...
    //**********************************************************************************************************************
    void GenericRobin_2nd_FullWave::GetResidualVector_Flux( std::map< unsigned int, std::complex<double> >& FluxValue, Vector< std::complex<double> >& ResidualVector )
    {
    ...
    //**********************************************************************************************************************
    void GenericRobin_2nd_FullWave::GetResidualVector_Single_Wave( Vector< std::complex<double> >& ResidualVector )
    {
    ...
    //**********************************************************************************************************************
    void GenericRobin_2nd_FullWave::GetResidualVector_Multpl_Waves( Vector< Vector<double> >& FluxValue, Vector< std::complex<double> >& ResidualVector )
	{
    ...
    //**********************************************************************************************************************
    void GenericRobin_2nd_FullWave::GetResidualVector_Gauss_Beams( Vector< std::complex<double> >& ResidualVector )
    {
    ...
    //**********************************************************************************************************************
    void GenericRobin_2nd_FullWave::GetResidualVector_Flux( Vector< Vector<double> >& FluxValue, Vector< std::complex<double> >& ResidualVector )
    {
    ...
    //* - Stiffness matrix
    //**********************************************************************************************************************
    void GenericRobin_2nd_FullWave::GetStiffnessMatrix( Matrix< std::complex<double> >& StiffMatrix ) 
    {
