...
#include "GenericRobin_2eg_FullWave.h"
...
{  	
    ...
    //**********************************************************************************************************************	
    void GenericRobin_2eg_FullWave::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    // - Area of the element
    //**********************************************************************************************************************
    double GenericRobin_2eg_FullWave::Calculate_Area()
    {
    ...
    //* - Exterior normal 
    //**********************************************************************************************************************	
    void GenericRobin_2eg_FullWave::Calculate_Exterior_Normal( Vector<double>& Next )
    {
		double v1[ 3 ], v2[ 3 ];
    ...
    //**********************************************************************************************************************	
    std::complex<double> GenericRobin_2eg_FullWave::Calculate_jK_div_Mu()
    {
        // Gaussian beam 
    ...
    //* - jk = j * w * sqrt ( ep * mu )
    //**********************************************************************************************************************	
    std::complex<double> GenericRobin_2eg_FullWave::Calculate_jK()
    {
        // Gaussian beam 
        if( (*mProperties)( COMPLEX_NEUMANN_FLOW )[ 5 ] == 3.0 )
        {
    ...
    //*******************************************************************************************************
    void GenericRobin_2eg_FullWave::Get_CoPlanar_XY_Axis( Vector<double>& X_axis,  Vector<double>& Y_axis )
	{
    ...
    //*******************************************************************************************************
    void GenericRobin_2eg_FullWave::Get_Vertices_Surface_Coordinates( Vector<double>& pX,  Vector<double>& pY )
    {
    ...
    //*******************************************************************************************************
    void GenericRobin_2eg_FullWave::Calculate_DN( double DN[ 2 ][ 3 ] )
    {
    ...
    //*******************************************************************************************************
    void GenericRobin_2eg_FullWave::Calculate_Edge_Lengths( Vector<double>& eLength )
    {
    ...
    //*******************************************************************************************************
	void GenericRobin_2eg_FullWave::Whitney2D_Ni_1st( Matrix<double>& Nx, Matrix<double>& Ny, Vector<double>& cX, Vector<double>& cY )
	{
		double L1, L2, L3;
    ...
    //******************************************************************************************************************************************
	void GenericRobin_2eg_FullWave::Face_Base( int edgeBase[ 2 ], int nodeBase[ 2 ], int nodeID[ 3 ], int edgeID[ 3 ], int oppnID[ 3 ] )
	{
    ...
    //******************************************************************************************************************************************
	void GenericRobin_2eg_FullWave::Order_Face_Bases( int n[ 2 ], int e[ 2 ] )
	{
		// Local face base IDs 
		int edgeBase[ 2 ];
		int nodeBase[ 2 ];
    ...
    //******************************************************************************************************************************************
	void GenericRobin_2eg_FullWave::Whitney2D_Ni_2nd( Matrix<double>& Nx, Matrix<double>& Ny, Vector<double>& cX, Vector<double>& cY )
	{
		int numPoints = cX.size();
    ...
    //**********************************************************************************************************************
    void GenericRobin_2eg_FullWave::GetResidualVector_Flux( std::map< unsigned int, std::complex<double> >& FluxValue, Vector< std::complex<double> >& ResidualVector )
    {
    ...
    //**********************************************************************************************************************
    void GenericRobin_2eg_FullWave::GetResidualVector_Single_Wave( Vector< std::complex<double> >& ResidualVector )
    {
		...
		for( int i=INI_I; i<END_I; i++ )
        {
            ...
            ResidualVector[ i + POS_I ] -= jK_div_Mu * sIntg_FNi;
        } 
    ...
    //**********************************************************************************************************************
    void GenericRobin_2eg_FullWave::GetResidualVector_Multpl_Waves( Vector< Vector<double> >& FluxValue, Vector< std::complex<double> >& ResidualVector )
	{
    ...
    //**********************************************************************************************************************
    void GenericRobin_2eg_FullWave::GetResidualVector_Gauss_Beams( Vector< std::complex<double> >& ResidualVector )
    {
    ...
    //**********************************************************************************************************************
    void GenericRobin_2eg_FullWave::GetResidualVector_Flux( Vector< Vector<double> >& FluxValue, Vector< std::complex<double> >& ResidualVector )
    {
    ...
    //* - Stiffness matrix
    //**********************************************************************************************************************
    void GenericRobin_2eg_FullWave::GetStiffnessMatrix( Matrix< std::complex<double> >& StiffMatrix ) 
    {
		...
		for( int i=0; i<mNumBases; i++ )
		{
			for( int j=i; j<mNumBases; j++ )
			{
				...
				EdgeBaseMatrix[ i ][ j ] = cRobinCoeff * sIntg_NiNj;
			}
		}
