...
## Windows
GiD_Path = r'./GiD 15.0.3/gid_offscreen.bat';
...
## Windows
ERMES_Exec = r'./ERMES_20.0.3/ERMES.gid/execs/win/ERMES_20.0.3.exe';

## Linux
# ERMES_Exec = r"./ERMES_20.0.3/ERMES.gid/execs/unix/ERMES_20.0.3_c7.4";
